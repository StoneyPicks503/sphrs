    ...
    <div style={{
      ...
      <style>{`
        ...
        @keyframes glow {
          ...
          50%      { box-shadow: 0 0 40px rgba(0,210,255,0.35); }
        }
        @keyframes fadeUp {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 14 }}>
          <div style={{ fontSize: 9, color: "#4a5a72", letterSpacing: 2, marginBottom: 8 }}>
            PASSWORD
          </div>
          <input
            type="password"
          ...
          />
          {error && (
            <div style={{ fontSize: 10, color: "#f87171", marginTop: 6, letterSpacing: 1 }}>
              ⚠️ {error}
            </div>
          )}
        </div>
